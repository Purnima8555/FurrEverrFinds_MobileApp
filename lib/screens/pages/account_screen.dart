      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Container(
              child: authViewModel.loggedInUser != null
                  ? Column(
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  Text('Name: ${authViewModel.loggedInUser?.name ?? 'No user'}'),
                  Text('Username: ${authViewModel.loggedInUser?.username ?? 'No user'}'),
                  Text('Email: ${authViewModel.loggedInUser?.email ?? 'No email'}')
                ],
              )
