  ...
  Widget build(BuildContext context) {
    return Consumer<AuthViewModel>(builder: (context, authVM, child) {
      return Scaffold(
        ...
        body: Padding(
          padding: EdgeInsets.only(top: 20), // Add space between AppBar and other content
          child: RefreshIndicator(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  if (_authViewModel.myProduct != null && _authViewModel.myProduct!.isEmpty) Center(child: Text("You haven't added any products yet!")),
